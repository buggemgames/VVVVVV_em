...
// include: /tmp/tmpj3ekhe8b.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'VVVVVV.data';
      var REMOTE_PACKAGE_BASE = 'VVVVVV.data';
...
Module['FS_createPath']("/lang", "ar", true, true);
Module['FS_createPath']("/lang/ar", "graphics", true, true);
Module['FS_createPath']("/lang", "ca", true, true);
Module['FS_createPath']("/lang/ca", "graphics", true, true);
Module['FS_createPath']("/lang", "cy", true, true);
Module['FS_createPath']("/lang/cy", "graphics", true, true);
Module['FS_createPath']("/lang", "de", true, true);
Module['FS_createPath']("/lang/de", "graphics", true, true);
Module['FS_createPath']("/lang", "en", true, true);
Module['FS_createPath']("/lang", "eo", true, true);
Module['FS_createPath']("/lang/eo", "graphics", true, true);
Module['FS_createPath']("/lang", "es", true, true);
Module['FS_createPath']("/lang/es", "graphics", true, true);
Module['FS_createPath']("/lang", "es_419", true, true);
Module['FS_createPath']("/lang/es_419", "graphics", true, true);
Module['FS_createPath']("/lang", "es_AR", true, true);
Module['FS_createPath']("/lang/es_AR", "graphics", true, true);
Module['FS_createPath']("/lang", "fr", true, true);
Module['FS_createPath']("/lang/fr", "graphics", true, true);
Module['FS_createPath']("/lang", "ga", true, true);
Module['FS_createPath']("/lang/ga", "graphics", true, true);
Module['FS_createPath']("/lang", "it", true, true);
Module['FS_createPath']("/lang/it", "graphics", true, true);
Module['FS_createPath']("/lang", "ja", true, true);
Module['FS_createPath']("/lang/ja", "graphics", true, true);
Module['FS_createPath']("/lang", "ko", true, true);
Module['FS_createPath']("/lang/ko", "graphics", true, true);
Module['FS_createPath']("/lang", "nl", true, true);
Module['FS_createPath']("/lang/nl", "graphics", true, true);
Module['FS_createPath']("/lang", "pl", true, true);
Module['FS_createPath']("/lang/pl", "graphics", true, true);
Module['FS_createPath']("/lang", "pt_BR", true, true);
Module['FS_createPath']("/lang/pt_BR", "graphics", true, true);
Module['FS_createPath']("/lang", "pt_PT", true, true);
Module['FS_createPath']("/lang/pt_PT", "graphics", true, true);
Module['FS_createPath']("/lang", "ru", true, true);
Module['FS_createPath']("/lang/ru", "graphics", true, true);
Module['FS_createPath']("/lang", "szl", true, true);
Module['FS_createPath']("/lang/szl", "graphics", true, true);
Module['FS_createPath']("/lang", "tr", true, true);
Module['FS_createPath']("/lang/tr", "graphics", true, true);
Module['FS_createPath']("/lang", "uk", true, true);
Module['FS_createPath']("/lang/uk", "graphics", true, true);
Module['FS_createPath']("/lang", "zh", true, true);
Module['FS_createPath']("/lang/zh", "graphics", true, true);
Module['FS_createPath']("/lang", "zh_TW", true, true);
Module['FS_createPath']("/lang/zh_TW", "graphics", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_VVVVVV.data');

      };
      Module['addRunDependency']('datafile_VVVVVV.data');
...
var ASM_CONSTS = {
 ...
 1478778: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 1479766: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1479849: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1479918: () => { return window.innerWidth; },  
 1479948: () => { return window.innerHeight; },  
 1479979: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
...
var dynCall_viiijji = Module['dynCall_viiijji'] = createExportWrapper('dynCall_viiijji', 9);
